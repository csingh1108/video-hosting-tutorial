...
public class S3Service implements FileService {
    ...
    public static final String BUCKET_NAME = "video-hosting-project-repo";
    ...
    public String uploadFile(MultipartFile file){
        ...
        //Enter key, input stream, and metadata into S3 Bucket
        try {
        ...
        //Create Access Control List so url can be retrieved without auth
